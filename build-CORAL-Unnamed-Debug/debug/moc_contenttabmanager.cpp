...
QT_MOC_LITERAL(7, 65, 3),
QT_MOC_LITERAL(8, 69, 11),
QT_MOC_LITERAL(9, 81, 10),
QT_MOC_LITERAL(10, 92, 19),
QT_MOC_LITERAL(11, 112, 10)
    },
    "ContentTabManager\0setupVideo\0\0videoURL\0"
    "setupPDF\0PDFPath\0setupWeb\0url\0restriction\0"
    "setupGroup\0QVector<Thumbnail*>\0"
    "thumbnails\0"
};
...
void ContentTabManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setupVideo((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->setupPDF((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->setupWeb((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 3: _t->setupGroup((*reinterpret_cast< QVector<Thumbnail*>(*)>(_a[1]))); break;
        default: ;
        }
