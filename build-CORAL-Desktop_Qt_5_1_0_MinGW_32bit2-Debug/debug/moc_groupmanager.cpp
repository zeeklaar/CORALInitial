...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GroupManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 40, 11)
    ...
    "GroupManager\0nextActivity\0\0prevActivity\0"
    "finishGroup\0"
};
...
void GroupManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->nextActivity(); break;
        case 1: _t->prevActivity(); break;
        case 2: _t->finishGroup(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject GroupManager::staticMetaObject = {
    { &Manager::staticMetaObject, qt_meta_stringdata_GroupManager.data,
      qt_meta_data_GroupManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GroupManager.stringdata))
